...
**Scenario:** Instrument win-rate uplift from the new playbook into the existing weekly pipeline review. Map CRM fields, BI widgets, and meeting owners so the metric appears on the dashboard leadership already uses. Fictional program: Acme Energy.
