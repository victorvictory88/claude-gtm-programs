...
**Scenario:** Acme Energy is about to launch a Claude code-analysis play for enterprise software AEs. Lock the measurement plan and baseline before launch: primary metric, supporting metrics, attribution method (sourced vs influenced), owners, scope, and 30/90-day definition of done. Use only labeled fictional demo values.
