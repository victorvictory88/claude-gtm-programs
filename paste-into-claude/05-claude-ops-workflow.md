...
**Scenario:** Design an enterprise RFP RAG workflow at operational volume for Acme Energy-style security packets: ingest, retrieve, draft, validate, human review. Contrast with summarizing email. Include volume, failure cost, ground-truth owners, and success metrics.
